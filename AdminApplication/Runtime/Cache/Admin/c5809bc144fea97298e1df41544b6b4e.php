...
<div class="container-fluid">
    <div class="row">
        <?php echo ($body['sider']); ?>
        <div class="col-md-10">
            <?php if($flag == 0 ): ?><a href="<?php echo U('statistics/Salerstatistics') ?>?type=1" type="button" class="btn btn-info pull-right">显示销售额</a>
            <?php else: ?>
                <a href="<?php echo U('statistics/Salerstatistics') ?>?type=0" type="button" class="btn btn-info pull-right">显示销量</a><?php endif; ?>
